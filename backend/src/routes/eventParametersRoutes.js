...
router.get('/event/:id/parameters', (req, res, next) => eventParametersController.getEventParametersByEvents(req, res, next));
router.get('/event/:id/user/:userId/parameters', (req, res, next) => eventParametersController.getEventParametersByEventsAndUser(req, res, next));
